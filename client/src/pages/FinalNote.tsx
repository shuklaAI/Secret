...
export default function FinalNote() {
  ...
  const fullText = "You know… I've been thinking about what you said, and honestly, the more I understand you, the more I realize how rare you are. The way you carry yourself, the way you respect your own boundaries, the way you feel things so genuinely… it's not common. People pretend a lot these days, but you don't. You're real, even when it's difficult, even when it makes you question yourself. And I won't lie… anyone who truly understands you, who actually sees you for who you are, wouldn't take that lightly. They'd value you in a way that's not loud or showy, but deep and constant. I don't think there's anything you need to change about yourself. If anything, the right person would just feel lucky to have you as you are. I guess… some people don't realize the worth of what's right in front of them. But that doesn't change its value. Well I thought of to give you this thing at ur birthday but ig I only have to take treat from you (MAA KSM YE LOVE LETTER NHI H)";
