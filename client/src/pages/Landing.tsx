    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Vaise to maine bdy pe banane ka socha tha but I thought it could cheer you up my dear
          </motion.span>
          ...
          >
            <p className="text-sm sm:text-base md:text-lg text-rose-700/80 font-light italic leading-relaxed px-4">
              you are my dearest my cutes girl
              <br />
              <span className="text-pink-600/90">🩷</span>
            </p>
          </motion.div>
        </motion.div>
