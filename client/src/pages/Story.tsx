  ...
  const sortedStory = [
    {
      ...
      content: "Honestly tu 1st sight mai mujhe bht sundr aur cute lgi thi (aisi ladki jispe mera chance hi ni ) aur hua v syad kch aisa hi madam ji ne bhaav tk ni dia tha starting mai .To maine to tumhain attitude queen man lia tha",
      imageUrl: "/unnati1.jpg",
      order: 1
    },
    {
      id: 2,
      title: "THE BOND",
      content: "I don't properly remember but i guess hamari baat properly khilkhilahat k bad honi start hui and ig republic day event k time hi mne acche se bat kri ho tmse",
      imageUrl: "/unnati2.jpg",
      order: 2
    },
    {
      id: 3,
      title: "Understanding each other",
      content: "gradually hmne kaafi acchi baate krni start krdi aur ig retreat and volfest were the best for us to uk get closer ...... now I'm in a kinda state where I just can't let u go",
      imageUrl: "/unnati3.jpg",
      order: 3
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header ref={headerRef} className="text-center py-12 sm:py-16 md:py-24 px-4 relative">
          ...
          >
            ...
            >
              Jldi jldi mai banaya h + I'm bad at story telling
            </motion.p>
          </motion.div>
